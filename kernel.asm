...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 e7 76 10 80 	movl   $0x801076e7,(%esp)
...
801009cb:	0f 84 67 02 00 00    	je     80100c38 <exec+0x298>
    end_op();
    cprintf("exec: fail\n");
    return -1;
  }
...
80100b40:	e8 4b 20 00 00       	call   80102b90 <end_op>
  cprintf("int EXEC\n");
80100b45:	c7 04 24 4d 6f 10 80 	movl   $0x80106f4d,(%esp)
80100b4c:	e8 ff fa ff ff       	call   80100650 <cprintf>
  cprintf(" Bot :%d\nTop :%d\n",KERNBASE - 4 - PGSIZE, KERNBASE - 4);
80100b51:	c7 44 24 08 fc ff ff 	movl   $0x7ffffffc,0x8(%esp)
80100b58:	7f 
80100b59:	c7 44 24 04 fc ef ff 	movl   $0x7fffeffc,0x4(%esp)
80100b60:	7f 
80100b61:	c7 04 24 57 6f 10 80 	movl   $0x80106f57,(%esp)
80100b68:	e8 e3 fa ff ff       	call   80100650 <cprintf>
  if((sp = allocuvm(pgdir, KERNBASE - 4- PGSIZE, KERNBASE - 4)) == 0)
80100b6d:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100b73:	c7 44 24 08 fc ff ff 	movl   $0x7ffffffc,0x8(%esp)
80100b7a:	7f 
80100b7b:	c7 44 24 04 fc ef ff 	movl   $0x7fffeffc,0x4(%esp)
80100b82:	7f 
80100b83:	89 04 24             	mov    %eax,(%esp)
80100b86:	e8 85 5d 00 00       	call   80106910 <allocuvm>
80100b8b:	85 c0                	test   %eax,%eax
80100b8d:	0f 84 8d 00 00 00    	je     80100c20 <exec+0x280>
  for(argc = 0; argv[argc]; argc++) {
80100b93:	8b 45 0c             	mov    0xc(%ebp),%eax
80100b96:	8b 00                	mov    (%eax),%eax
80100b98:	85 c0                	test   %eax,%eax
80100b9a:	0f 84 91 01 00 00    	je     80100d31 <exec+0x391>
80100ba0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100ba3:	31 d2                	xor    %edx,%edx
80100ba5:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100baa:	8d 71 04             	lea    0x4(%ecx),%esi
80100bad:	89 cf                	mov    %ecx,%edi
80100baf:	89 f1                	mov    %esi,%ecx
80100bb1:	89 d6                	mov    %edx,%esi
80100bb3:	89 ca                	mov    %ecx,%edx
80100bb5:	eb 27                	jmp    80100bde <exec+0x23e>
80100bb7:	90                   	nop
80100bb8:	8b 95 e8 fe ff ff    	mov    -0x118(%ebp),%edx
    ustack[3+argc] = sp;
80100bbe:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100bc4:	89 9c b5 64 ff ff ff 	mov    %ebx,-0x9c(%ebp,%esi,4)
  for(argc = 0; argv[argc]; argc++) {
80100bcb:	83 c6 01             	add    $0x1,%esi
80100bce:	8b 02                	mov    (%edx),%eax
80100bd0:	89 d7                	mov    %edx,%edi
80100bd2:	85 c0                	test   %eax,%eax
80100bd4:	74 7d                	je     80100c53 <exec+0x2b3>
80100bd6:	83 c2 04             	add    $0x4,%edx
    if(argc >= MAXARG)
80100bd9:	83 fe 20             	cmp    $0x20,%esi
80100bdc:	74 42                	je     80100c20 <exec+0x280>
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100bde:	89 04 24             	mov    %eax,(%esp)
80100be1:	89 95 e8 fe ff ff    	mov    %edx,-0x118(%ebp)
80100be7:	e8 c4 38 00 00       	call   801044b0 <strlen>
80100bec:	f7 d0                	not    %eax
80100bee:	01 c3                	add    %eax,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100bf0:	8b 07                	mov    (%edi),%eax
    sp = (sp - (strlen(argv[argc]) + 1)) & ~3;
80100bf2:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100bf5:	89 04 24             	mov    %eax,(%esp)
80100bf8:	e8 b3 38 00 00       	call   801044b0 <strlen>
80100bfd:	83 c0 01             	add    $0x1,%eax
80100c00:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c04:	8b 07                	mov    (%edi),%eax
80100c06:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80100c0a:	89 44 24 08          	mov    %eax,0x8(%esp)
80100c0e:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100c14:	89 04 24             	mov    %eax,(%esp)
80100c17:	e8 84 61 00 00       	call   80106da0 <copyout>
80100c1c:	85 c0                	test   %eax,%eax
80100c1e:	79 98                	jns    80100bb8 <exec+0x218>
    freevm(pgdir);
80100c20:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100c26:	89 04 24             	mov    %eax,(%esp)
80100c29:	e8 02 5e 00 00       	call   80106a30 <freevm>
  return -1;
80100c2e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100c33:	e9 da fd ff ff       	jmp    80100a12 <exec+0x72>
    end_op();
80100c38:	e8 53 1f 00 00       	call   80102b90 <end_op>
    cprintf("exec: fail\n");
80100c3d:	c7 04 24 41 6f 10 80 	movl   $0x80106f41,(%esp)
80100c44:	e8 07 fa ff ff       	call   80100650 <cprintf>
    return -1;
80100c49:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100c4e:	e9 bf fd ff ff       	jmp    80100a12 <exec+0x72>
80100c53:	89 f2                	mov    %esi,%edx
  ustack[3+argc] = 0;
80100c55:	c7 84 95 64 ff ff ff 	movl   $0x0,-0x9c(%ebp,%edx,4)
80100c5c:	00 00 00 00 
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c60:	8d 04 95 04 00 00 00 	lea    0x4(,%edx,4),%eax
  ustack[1] = argc;
80100c67:	89 95 5c ff ff ff    	mov    %edx,-0xa4(%ebp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c6d:	89 da                	mov    %ebx,%edx
80100c6f:	29 c2                	sub    %eax,%edx
  sp -= (3+argc+1) * 4;
80100c71:	83 c0 0c             	add    $0xc,%eax
80100c74:	29 c3                	sub    %eax,%ebx
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c76:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c7a:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100c80:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80100c84:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  ustack[0] = 0xffffffff;  // fake return PC
80100c88:	c7 85 58 ff ff ff ff 	movl   $0xffffffff,-0xa8(%ebp)
80100c8f:	ff ff ff 
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c92:	89 04 24             	mov    %eax,(%esp)
  ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c95:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c9b:	e8 00 61 00 00       	call   80106da0 <copyout>
80100ca0:	85 c0                	test   %eax,%eax
80100ca2:	0f 88 78 ff ff ff    	js     80100c20 <exec+0x280>
  for(last=s=path; *s; s++)
80100ca8:	8b 45 08             	mov    0x8(%ebp),%eax
80100cab:	0f b6 10             	movzbl (%eax),%edx
80100cae:	84 d2                	test   %dl,%dl
80100cb0:	74 19                	je     80100ccb <exec+0x32b>
80100cb2:	8b 4d 08             	mov    0x8(%ebp),%ecx
80100cb5:	83 c0 01             	add    $0x1,%eax
      last = s+1;
...
80100cc6:	75 f0                	jne    80100cb8 <exec+0x318>
80100cc8:	89 4d 08             	mov    %ecx,0x8(%ebp)
  safestrcpy(curproc->name, last, sizeof(curproc->name));
80100ccb:	8b bd f4 fe ff ff    	mov    -0x10c(%ebp),%edi
80100cd1:	8b 45 08             	mov    0x8(%ebp),%eax
80100cd4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80100cdb:	00 
80100cdc:	89 44 24 04          	mov    %eax,0x4(%esp)
80100ce0:	89 f8                	mov    %edi,%eax
80100ce2:	83 c0 6c             	add    $0x6c,%eax
80100ce5:	89 04 24             	mov    %eax,(%esp)
80100ce8:	e8 83 37 00 00       	call   80104470 <safestrcpy>
  curproc->pgdir = pgdir;
80100ced:	8b 8d f0 fe ff ff    	mov    -0x110(%ebp),%ecx
  oldpgdir = curproc->pgdir;
80100cf3:	8b 77 04             	mov    0x4(%edi),%esi
  curproc->tf->eip = elf.entry;  // main
80100cf6:	8b 47 18             	mov    0x18(%edi),%eax
  curproc->pgdir = pgdir;
80100cf9:	89 4f 04             	mov    %ecx,0x4(%edi)
  curproc->sz = sz;
80100cfc:	8b 8d ec fe ff ff    	mov    -0x114(%ebp),%ecx
80100d02:	89 0f                	mov    %ecx,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100d04:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d0a:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d0d:	8b 47 18             	mov    0x18(%edi),%eax
80100d10:	89 58 44             	mov    %ebx,0x44(%eax)
  curproc->num_pgs = 1;
80100d13:	c7 47 7c 01 00 00 00 	movl   $0x1,0x7c(%edi)
  switchuvm(curproc);
80100d1a:	89 3c 24             	mov    %edi,(%esp)
80100d1d:	e8 8e 59 00 00       	call   801066b0 <switchuvm>
  freevm(oldpgdir);
80100d22:	89 34 24             	mov    %esi,(%esp)
80100d25:	e8 06 5d 00 00       	call   80106a30 <freevm>
  return 0;
80100d2a:	31 c0                	xor    %eax,%eax
80100d2c:	e9 e1 fc ff ff       	jmp    80100a12 <exec+0x72>
  for(argc = 0; argv[argc]; argc++) {
80100d31:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100d36:	31 d2                	xor    %edx,%edx
80100d38:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d3e:	e9 12 ff ff ff       	jmp    80100c55 <exec+0x2b5>
...
80100d56:	c7 44 24 04 69 6f 10 	movl   $0x80106f69,0x4(%esp)
80100d5d:	80 
...
80100e16:	c3                   	ret    
    panic("filedup");
80100e17:	c7 04 24 70 6f 10 80 	movl   $0x80106f70,(%esp)
...
80100ed7:	e9 b4 1c 00 00       	jmp    80102b90 <end_op>
    panic("fileclose");
80100edc:	c7 04 24 78 6f 10 80 	movl   $0x80106f78,(%esp)
...
80100fc5:	eb d8                	jmp    80100f9f <fileread+0x5f>
  panic("fileread");
80100fc7:	c7 04 24 82 6f 10 80 	movl   $0x80106f82,(%esp)
...
801010dc:	e9 1f 22 00 00       	jmp    80103300 <pipewrite>
        panic("short filewrite");
801010e1:	c7 04 24 8b 6f 10 80 	movl   $0x80106f8b,(%esp)
801010e8:	e8 73 f2 ff ff       	call   80100360 <panic>
  panic("filewrite");
801010ed:	c7 04 24 91 6f 10 80 	movl   $0x80106f91,(%esp)
...
801011a5:	c7 04 24 9b 6f 10 80 	movl   $0x80106f9b,(%esp)
...
801012cd:	c7 04 24 b1 6f 10 80 	movl   $0x80106fb1,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  panic("bmap: out of range");
80101387:	c7 04 24 c1 6f 10 80 	movl   $0x80106fc1,(%esp)
...
80101469:	c7 04 24 d4 6f 10 80 	movl   $0x80106fd4,(%esp)
...
8010148c:	c7 44 24 04 e7 6f 10 	movl   $0x80106fe7,0x4(%esp)
80101493:	80 
...
801014a9:	c7 44 24 04 ee 6f 10 	movl   $0x80106fee,0x4(%esp)
801014b0:	80 
...
801015f1:	c7 04 24 f4 6f 10 80 	movl   $0x80106ff4,(%esp)
...
80101774:	0f 85 76 ff ff ff    	jne    801016f0 <ilock+0x30>
      panic("ilock: no type");
8010177a:	c7 04 24 0c 70 10 80 	movl   $0x8010700c,(%esp)
80101781:	e8 da eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101786:	c7 04 24 06 70 10 80 	movl   $0x80107006,(%esp)
...
801017ce:	e9 1d 28 00 00       	jmp    80103ff0 <releasesleep>
    panic("iunlock");
801017d3:	c7 04 24 1b 70 10 80 	movl   $0x8010701b,(%esp)
...
80101c71:	c3                   	ret    
      panic("dirlookup read");
80101c72:	c7 04 24 35 70 10 80 	movl   $0x80107035,(%esp)
80101c79:	e8 e2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c7e:	c7 04 24 23 70 10 80 	movl   $0x80107023,(%esp)
...
80101ef3:	eb e9                	jmp    80101ede <dirlink+0xae>
      panic("dirlink read");
80101ef5:	c7 04 24 44 70 10 80 	movl   $0x80107044,(%esp)
...
80102de6:	e8 a5 38 00 00       	call   80106690 <switchkvm>
  seginit();
80102deb:	e8 60 37 00 00       	call   80106550 <seginit>
  lapicinit();
...
80102e23:	e8 18 3d 00 00       	call   80106b40 <kvmalloc>
...
80102e35:	e8 16 37 00 00       	call   80106550 <seginit>
  picinit();       // disable pic
...
80102e55:	e8 d6 3f 00 00       	call   80106e30 <shminit>
  tvinit();        // trap vectors
80102e5a:	e8 01 26 00 00       	call   80105460 <tvinit>
80102e5f:	90                   	nop
  binit();         // buffer cache
...
801036f3:	e8 b8 33 00 00       	call   80106ab0 <setupkvm>
...
8010384a:	e8 c1 31 00 00       	call   80106a10 <deallocuvm>
...
8010388e:	e8 fd 32 00 00       	call   80106b90 <copyuvm>
80103893:	85 c0                	test   %eax,%eax
80103895:	89 47 04             	mov    %eax,0x4(%edi)
80103898:	0f 84 af 00 00 00    	je     8010394d <fork+0xed>
  np->num_pgs = curproc->num_pgs;
8010389e:	8b 43 7c             	mov    0x7c(%ebx),%eax
801038a1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801038a4:	89 41 7c             	mov    %eax,0x7c(%ecx)
  np->sz = curproc->sz;
801038a7:	8b 03                	mov    (%ebx),%eax
  *np->tf = *curproc->tf;
801038a9:	8b 79 18             	mov    0x18(%ecx),%edi
  np->parent = curproc;
801038ac:	89 59 14             	mov    %ebx,0x14(%ecx)
  np->sz = curproc->sz;
801038af:	89 01                	mov    %eax,(%ecx)
  *np->tf = *curproc->tf;
801038b1:	8b 73 18             	mov    0x18(%ebx),%esi
801038b4:	89 c8                	mov    %ecx,%eax
801038b6:	b9 13 00 00 00       	mov    $0x13,%ecx
801038bb:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
801038bd:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
801038bf:	8b 40 18             	mov    0x18(%eax),%eax
...
801039c2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039c5:	e8 e6 2c 00 00       	call   801066b0 <switchuvm>
...
801039db:	e8 eb 0a 00 00       	call   801044cb <swtch>
      switchkvm();
801039e0:	e8 ab 2c 00 00       	call   80106690 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103d48:	e8 e3 2c 00 00       	call   80106a30 <freevm>
        release(&ptable.lock);
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 e7 76 10 80 	movl   $0x801076e7,(%esp)
...
801044e6:	3d f8 ff ff 7f       	cmp    $0x7ffffff8,%eax
...
80104503:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  if(addr >= KERNBASE - 4)
80104506:	81 fa fb ff ff 7f    	cmp    $0x7ffffffb,%edx
...
801045fc:	8b 55 f4             	mov    -0xc(%ebp),%edx
  if(addr >= KERNBASE - 4)
801045ff:	81 fa fb ff ff 7f    	cmp    $0x7ffffffb,%edx
...
80104620:	3d fb ff ff 7f       	cmp    $0x7ffffffb,%eax
...
80104645:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104648:	e8 63 f0 ff ff       	call   801036b0 <myproc>
...
8010465d:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
...
80104686:	c7 04 24 91 75 10 80 	movl   $0x80107591,(%esp)
...
801046b6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801046b9:	e8 f2 ef ff ff       	call   801036b0 <myproc>
...
8010470c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010470f:	e8 1c d8 ff ff       	call   80101f30 <nameiparent>
...
80104721:	e8 9a cf ff ff       	call   801016c0 <ilock>
...
8010476b:	e8 b0 d1 ff ff       	call   80101920 <iunlockput>
}
...
8010478d:	e8 9e cd ff ff       	call   80101530 <ialloc>
...
8010479f:	e8 1c cf ff ff       	call   801016c0 <ilock>
  ip->major = major;
...
801047c0:	e8 3b ce ff ff       	call   80101600 <iupdate>
...
8010488a:	e8 b1 fc ff ff       	call   80104540 <argint>
...
80104899:	e8 12 ee ff ff       	call   801036b0 <myproc>
...
80104909:	e8 d2 c4 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104960:	e8 1b fc ff ff       	call   80104580 <argptr>
...
8010497d:	e8 be c5 ff ff       	call   80100f40 <fileread>
}
80104982:	c9                   	leave  
80104983:	c3                   	ret    
...
801049b2:	e8 89 fb ff ff       	call   80104540 <argint>
...
801049d0:	e8 ab fb ff ff       	call   80104580 <argptr>
...
801049ed:	e8 ee c5 ff ff       	call   80100fe0 <filewrite>
}
801049f2:	c9                   	leave  
801049f3:	c3                   	ret    
...
80104a13:	78 23                	js     80104a38 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104a15:	e8 96 ec ff ff       	call   801036b0 <myproc>
...
80104a2b:	e8 00 c4 ff ff       	call   80100e30 <fileclose>
  return 0;
...
80104a6a:	e8 11 fb ff ff       	call   80104580 <argptr>
...
80104a80:	e8 6b c4 ff ff       	call   80100ef0 <filestat>
}
80104a85:	c9                   	leave  
80104a86:	c3                   	ret    
80104a87:	90                   	nop
...
80104ac9:	0f 88 cb 00 00 00    	js     80104b9a <sys_link+0x10a>
  begin_op();
80104acf:	e8 4c e0 ff ff       	call   80102b20 <begin_op>
  if((ip = namei(old)) == 0){
80104ad4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104ad7:	89 04 24             	mov    %eax,(%esp)
80104ada:	e8 31 d4 ff ff       	call   80101f10 <namei>
...
80104aec:	e8 cf cb ff ff       	call   801016c0 <ilock>
  if(ip->type == T_DIR){
...
80104b07:	e8 f4 ca ff ff       	call   80101600 <iupdate>
  iunlock(ip);
80104b0c:	89 1c 24             	mov    %ebx,(%esp)
80104b0f:	e8 8c cc ff ff       	call   801017a0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104b14:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b17:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b1b:	89 04 24             	mov    %eax,(%esp)
80104b1e:	e8 0d d4 ff ff       	call   80101f30 <nameiparent>
...
80104b2c:	e8 8f cb ff ff       	call   801016c0 <ilock>
...
80104b45:	e8 e6 d2 ff ff       	call   80101e30 <dirlink>
80104b4a:	85 c0                	test   %eax,%eax
80104b4c:	78 22                	js     80104b70 <sys_link+0xe0>
  iunlockput(dp);
80104b4e:	89 34 24             	mov    %esi,(%esp)
80104b51:	e8 ca cd ff ff       	call   80101920 <iunlockput>
  iput(ip);
80104b56:	89 1c 24             	mov    %ebx,(%esp)
80104b59:	e8 82 cc ff ff       	call   801017e0 <iput>
  end_op();
80104b5e:	e8 2d e0 ff ff       	call   80102b90 <end_op>
}
...
80104b73:	e8 a8 cd ff ff       	call   80101920 <iunlockput>
  ilock(ip);
80104b78:	89 1c 24             	mov    %ebx,(%esp)
80104b7b:	e8 40 cb ff ff       	call   801016c0 <ilock>
  ip->nlink--;
80104b80:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104b85:	89 1c 24             	mov    %ebx,(%esp)
80104b88:	e8 73 ca ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
80104b8d:	89 1c 24             	mov    %ebx,(%esp)
80104b90:	e8 8b cd ff ff       	call   80101920 <iunlockput>
  end_op();
80104b95:	e8 f6 df ff ff       	call   80102b90 <end_op>
}
...
80104bce:	0f 88 76 01 00 00    	js     80104d4a <sys_unlink+0x19a>
  begin_op();
80104bd4:	e8 47 df ff ff       	call   80102b20 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104be6:	e8 45 d3 ff ff       	call   80101f30 <nameiparent>
...
80104c01:	c7 44 24 04 3c 76 10 	movl   $0x8010763c,0x4(%esp)
80104c08:	80 
80104c09:	89 1c 24             	mov    %ebx,(%esp)
80104c0c:	e8 8f cf ff ff       	call   80101ba0 <namecmp>
80104c11:	85 c0                	test   %eax,%eax
80104c13:	0f 84 21 01 00 00    	je     80104d3a <sys_unlink+0x18a>
80104c19:	c7 44 24 04 3b 76 10 	movl   $0x8010763b,0x4(%esp)
80104c20:	80 
80104c21:	89 1c 24             	mov    %ebx,(%esp)
80104c24:	e8 77 cf ff ff       	call   80101ba0 <namecmp>
...
80104c3f:	e8 8c cf ff ff       	call   80101bd0 <dirlookup>
...
80104c7e:	e8 0d f6 ff ff       	call   80104290 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104c9c:	e8 cf cd ff ff       	call   80101a70 <writei>
...
80104d21:	e8 4a cc ff ff       	call   80101970 <readi>
...
80104d35:	e8 e6 cb ff ff       	call   80101920 <iunlockput>
  iunlockput(dp);
...
80104d63:	e8 98 c8 ff ff       	call   80101600 <iupdate>
80104d68:	e9 48 ff ff ff       	jmp    80104cb5 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104d6d:	c7 04 24 60 76 10 80 	movl   $0x80107660,(%esp)
80104d74:	e8 e7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d79:	c7 04 24 72 76 10 80 	movl   $0x80107672,(%esp)
80104d80:	e8 db b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d85:	c7 04 24 4e 76 10 80 	movl   $0x8010764e,(%esp)
...
80104dd2:	e8 69 f7 ff ff       	call   80104540 <argint>
80104dd7:	85 c0                	test   %eax,%eax
80104dd9:	0f 88 b6 00 00 00    	js     80104e95 <sys_open+0xf5>
    return -1;

  begin_op();
80104ddf:	e8 3c dd ff ff       	call   80102b20 <begin_op>
...
80104df4:	e8 17 d1 ff ff       	call   80101f10 <namei>
...
80104e06:	e8 b5 c8 ff ff       	call   801016c0 <ilock>
...
80104e37:	e8 64 c9 ff ff       	call   801017a0 <iunlock>
  end_op();
...
80104e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    end_op();
80104e90:	e8 fb dc ff ff       	call   80102b90 <end_op>
}
...
80104ee3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80104ee6:	e8 35 dc ff ff       	call   80102b20 <begin_op>
...
80104f1f:	e8 fc c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104f24:	e8 67 dc ff ff       	call   80102b90 <end_op>
  return 0;
...
80104f2d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80104f30:	e8 5b dc ff ff       	call   80102b90 <end_op>
    return -1;
...
80104f43:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80104f46:	e8 d5 db ff ff       	call   80102b20 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80104f70:	e8 cb f5 ff ff       	call   80104540 <argint>
  if((argstr(0, &path)) < 0 ||
...
80104f87:	e8 b4 f5 ff ff       	call   80104540 <argint>
     argint(1, &major) < 0 ||
...
80104faf:	e8 6c c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104fb4:	e8 d7 db ff ff       	call   80102b90 <end_op>
  return 0;
...
80104fd5:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80104fd8:	e8 d3 e6 ff ff       	call   801036b0 <myproc>
...
80105001:	e8 0a cf ff ff       	call   80101f10 <namei>
...
8010500f:	e8 ac c6 ff ff       	call   801016c0 <ilock>
  if(ip->type != T_DIR){
...
8010501c:	75 22                	jne    80105040 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010501e:	e8 7d c7 ff ff       	call   801017a0 <iunlock>
  iput(curproc->cwd);
80105023:	8b 46 68             	mov    0x68(%esi),%eax
80105026:	89 04 24             	mov    %eax,(%esp)
80105029:	e8 b2 c7 ff ff       	call   801017e0 <iput>
  end_op();
8010502e:	e8 5d db ff ff       	call   80102b90 <end_op>
  curproc->cwd = ip;
  return 0;
...
8010503f:	90                   	nop
    iunlockput(ip);
80105040:	e8 db c8 ff ff       	call   80101920 <iunlockput>
    end_op();
80105045:	e8 46 db ff ff       	call   80102b90 <end_op>
}
...
8010509b:	e8 a0 f4 ff ff       	call   80104540 <argint>
...
801050cb:	e8 c0 f1 ff ff       	call   80104290 <memset>
    if(i >= NELEM(argv))
      return -1;
...
801050e0:	e8 fb f3 ff ff       	call   801044e0 <fetchint>
...
801050fa:	e8 01 f4 ff ff       	call   80104500 <fetchstr>
...
8010516d:	e8 0e f4 ff ff       	call   80104580 <argptr>
...
80105183:	e8 f8 df ff ff       	call   80103180 <pipealloc>
...
80105204:	e8 37 f3 ff ff       	call   80104540 <argint>
...
80105223:	e8 58 f3 ff ff       	call   80104580 <argptr>
...
80105239:	e8 52 1c 00 00       	call   80106e90 <shm_open>
}
8010523e:	c9                   	leave  
8010523f:	c3                   	ret    
    return -1;
...
80105273:	e8 28 1c 00 00       	call   80106ea0 <shm_close>
}
80105278:	c9                   	leave  
80105279:	c3                   	ret    
...
80105293:	5d                   	pop    %ebp
  return fork();
80105294:	e9 c7 e5 ff ff       	jmp    80103860 <fork>
...
801052d4:	e8 67 f2 ff ff       	call   80104540 <argint>
...
801053d3:	e8 68 ee ff ff       	call   80104240 <release>
      return -1;
...
801053ef:	e8 4c ee ff ff       	call   80104240 <release>
}
...
801054b9:	c7 44 24 04 81 76 10 	movl   $0x80107681,0x4(%esp)
801054c0:	80 
...
801054e6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801054ec:	e8 6f eb ff ff       	call   80104060 <initlock>
}
801054f1:	c9                   	leave  
801054f2:	c3                   	ret    
...
8010553c:	83 7b 30 40          	cmpl   $0x40,0x30(%ebx)
80105540:	0f 84 1a 01 00 00    	je     80105660 <trap+0x130>
    syscall();
    if(myproc()->killed)
      exit();
    return;
...
8010554b:	89 c6                	mov    %eax,%esi
  switch(tf->trapno){
8010554d:	8b 43 30             	mov    0x30(%ebx),%eax
80105550:	8d 50 f2             	lea    -0xe(%eax),%edx
80105553:	83 fa 31             	cmp    $0x31,%edx
80105556:	77 08                	ja     80105560 <trap+0x30>
80105558:	ff 24 95 8c 77 10 80 	jmp    *-0x7fef8874(,%edx,4)
8010555f:	90                   	nop
...
80105560:	e8 4b e1 ff ff       	call   801036b0 <myproc>
80105565:	85 c0                	test   %eax,%eax
80105567:	0f 84 93 02 00 00    	je     80105800 <trap+0x2d0>
8010556d:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105571:	0f 84 89 02 00 00    	je     80105800 <trap+0x2d0>
...
8010557a:	8b 53 38             	mov    0x38(%ebx),%edx
8010557d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105580:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105583:	e8 08 e1 ff ff       	call   80103690 <cpuid>
80105588:	8b 73 30             	mov    0x30(%ebx),%esi
8010558b:	89 c7                	mov    %eax,%edi
8010558d:	8b 43 34             	mov    0x34(%ebx),%eax
80105590:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105593:	e8 18 e1 ff ff       	call   801036b0 <myproc>
80105598:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010559b:	e8 10 e1 ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055a0:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801055a3:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055a7:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055aa:	8b 55 dc             	mov    -0x24(%ebp),%edx
801055ad:	89 7c 24 14          	mov    %edi,0x14(%esp)
801055b1:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
801055b5:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            myproc()->pid, myproc()->name, tf->trapno,
801055b8:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055bb:	89 54 24 18          	mov    %edx,0x18(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801055bf:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055c3:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801055c7:	8b 40 10             	mov    0x10(%eax),%eax
801055ca:	c7 04 24 48 77 10 80 	movl   $0x80107748,(%esp)
801055d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801055d5:	e8 76 b0 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801055da:	e8 d1 e0 ff ff       	call   801036b0 <myproc>
801055df:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
...
801055e8:	e8 c3 e0 ff ff       	call   801036b0 <myproc>
801055ed:	85 c0                	test   %eax,%eax
801055ef:	74 0c                	je     801055fd <trap+0xcd>
801055f1:	e8 ba e0 ff ff       	call   801036b0 <myproc>
801055f6:	8b 50 24             	mov    0x24(%eax),%edx
801055f9:	85 d2                	test   %edx,%edx
801055fb:	75 4b                	jne    80105648 <trap+0x118>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801055fd:	e8 ae e0 ff ff       	call   801036b0 <myproc>
80105602:	85 c0                	test   %eax,%eax
80105604:	74 10                	je     80105616 <trap+0xe6>
80105606:	e8 a5 e0 ff ff       	call   801036b0 <myproc>
8010560b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010560f:	90                   	nop
80105610:	0f 84 82 00 00 00    	je     80105698 <trap+0x168>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105616:	e8 95 e0 ff ff       	call   801036b0 <myproc>
8010561b:	85 c0                	test   %eax,%eax
8010561d:	74 1a                	je     80105639 <trap+0x109>
8010561f:	90                   	nop
80105620:	e8 8b e0 ff ff       	call   801036b0 <myproc>
80105625:	8b 40 24             	mov    0x24(%eax),%eax
80105628:	85 c0                	test   %eax,%eax
8010562a:	74 0d                	je     80105639 <trap+0x109>
8010562c:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105630:	83 e0 03             	and    $0x3,%eax
80105633:	66 83 f8 03          	cmp    $0x3,%ax
80105637:	74 50                	je     80105689 <trap+0x159>
    exit();
}
80105639:	83 c4 3c             	add    $0x3c,%esp
8010563c:	5b                   	pop    %ebx
8010563d:	5e                   	pop    %esi
8010563e:	5f                   	pop    %edi
8010563f:	5d                   	pop    %ebp
...
80105653:	75 a8                	jne    801055fd <trap+0xcd>
    exit();
80105655:	e8 56 e4 ff ff       	call   80103ab0 <exit>
8010565a:	eb a1                	jmp    801055fd <trap+0xcd>
...
8010566a:	0f 85 48 01 00 00    	jne    801057b8 <trap+0x288>
    myproc()->tf = tf;
80105670:	e8 3b e0 ff ff       	call   801036b0 <myproc>
80105675:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105678:	e8 c3 ef ff ff       	call   80104640 <syscall>
    if(myproc()->killed)
8010567d:	e8 2e e0 ff ff       	call   801036b0 <myproc>
80105682:	8b 48 24             	mov    0x24(%eax),%ecx
80105685:	85 c9                	test   %ecx,%ecx
80105687:	74 b0                	je     80105639 <trap+0x109>
}
...
8010569c:	0f 85 74 ff ff ff    	jne    80105616 <trap+0xe6>
    yield();
801056a2:	e8 29 e5 ff ff       	call   80103bd0 <yield>
801056a7:	e9 6a ff ff ff       	jmp    80105616 <trap+0xe6>
801056ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801056b0:	0f 20 d2             	mov    %cr2,%edx
    if((rcr2() > ( KERNBASE - 4 - (curproc->num_pgs*PGSIZE))) ){
801056b3:	8b 46 7c             	mov    0x7c(%esi),%eax
801056b6:	f7 d8                	neg    %eax
801056b8:	c1 e0 0c             	shl    $0xc,%eax
801056bb:	05 fc ff ff 7f       	add    $0x7ffffffc,%eax
801056c0:	39 d0                	cmp    %edx,%eax
801056c2:	0f 82 7a 01 00 00    	jb     80105842 <trap+0x312>
	cprintf("InELSEE\n");
801056c8:	c7 04 24 a7 76 10 80 	movl   $0x801076a7,(%esp)
801056cf:	e8 7c af ff ff       	call   80100650 <cprintf>
801056d4:	0f 20 d2             	mov    %cr2,%edx
	cprintf("FIRST IF\n %d\n%d\n",rcr2(),KERNBASE - 4 - curproc->num_pgs*PGSIZE);
801056d7:	8b 46 7c             	mov    0x7c(%esi),%eax
801056da:	89 54 24 04          	mov    %edx,0x4(%esp)
801056de:	c7 04 24 b0 76 10 80 	movl   $0x801076b0,(%esp)
801056e5:	f7 d8                	neg    %eax
801056e7:	c1 e0 0c             	shl    $0xc,%eax
801056ea:	05 fc ff ff 7f       	add    $0x7ffffffc,%eax
801056ef:	89 44 24 08          	mov    %eax,0x8(%esp)
801056f3:	e8 58 af ff ff       	call   80100650 <cprintf>
	if(allocuvm(curproc->pgdir, (KERNBASE - 4 - (curproc->num_pgs+1)*PGSIZE), (KERNBASE - 4 - (curproc->num_pgs)*PGSIZE))== 0){
801056f8:	8b 46 7c             	mov    0x7c(%esi),%eax
801056fb:	89 c2                	mov    %eax,%edx
801056fd:	f7 d0                	not    %eax
801056ff:	f7 da                	neg    %edx
80105701:	c1 e2 0c             	shl    $0xc,%edx
80105704:	c1 e0 0c             	shl    $0xc,%eax
80105707:	81 c2 fc ff ff 7f    	add    $0x7ffffffc,%edx
8010570d:	05 fc ff ff 7f       	add    $0x7ffffffc,%eax
80105712:	89 54 24 08          	mov    %edx,0x8(%esp)
80105716:	89 44 24 04          	mov    %eax,0x4(%esp)
8010571a:	8b 46 04             	mov    0x4(%esi),%eax
8010571d:	89 04 24             	mov    %eax,(%esp)
80105720:	e8 eb 11 00 00       	call   80106910 <allocuvm>
80105725:	85 c0                	test   %eax,%eax
80105727:	0f 84 09 01 00 00    	je     80105836 <trap+0x306>
	curproc->num_pgs +=1;
8010572d:	83 46 7c 01          	addl   $0x1,0x7c(%esi)
    cprintf("BIIIAAATTTCHHHH \n");
80105731:	c7 04 24 d7 76 10 80 	movl   $0x801076d7,(%esp)
80105738:	e8 13 af ff ff       	call   80100650 <cprintf>
    break;
8010573d:	e9 a6 fe ff ff       	jmp    801055e8 <trap+0xb8>
80105742:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105748:	e8 43 df ff ff       	call   80103690 <cpuid>
8010574d:	85 c0                	test   %eax,%eax
8010574f:	90                   	nop
80105750:	74 7e                	je     801057d0 <trap+0x2a0>
    lapiceoi();
80105752:	e8 39 d0 ff ff       	call   80102790 <lapiceoi>
    break;
80105757:	e9 8c fe ff ff       	jmp    801055e8 <trap+0xb8>
...
80105765:	e8 26 d0 ff ff       	call   80102790 <lapiceoi>
    break;
8010576a:	e9 79 fe ff ff       	jmp    801055e8 <trap+0xb8>
8010576f:	90                   	nop
    uartintr();
...
80105775:	e8 16 d0 ff ff       	call   80102790 <lapiceoi>
    break;
8010577a:	e9 69 fe ff ff       	jmp    801055e8 <trap+0xb8>
8010577f:	90                   	nop
...
8010578c:	c7 04 24 f0 76 10 80 	movl   $0x801076f0,(%esp)
...
801057a4:	e8 e7 cf ff ff       	call   80102790 <lapiceoi>
    break;
801057a9:	e9 3a fe ff ff       	jmp    801055e8 <trap+0xb8>
801057ae:	66 90                	xchg   %ax,%ax
    ideintr();
801057b0:	e8 db c8 ff ff       	call   80102090 <ideintr>
801057b5:	eb 9b                	jmp    80105752 <trap+0x222>
801057b7:	90                   	nop
801057b8:	90                   	nop
801057b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      exit();
801057c0:	e8 eb e2 ff ff       	call   80103ab0 <exit>
801057c5:	e9 a6 fe ff ff       	jmp    80105670 <trap+0x140>
801057ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
801057d0:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057d7:	e8 74 e9 ff ff       	call   80104150 <acquire>
      wakeup(&ticks);
801057dc:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
801057e3:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
801057ea:	e8 b1 e5 ff ff       	call   80103da0 <wakeup>
      release(&tickslock);
801057ef:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801057f6:	e8 45 ea ff ff       	call   80104240 <release>
801057fb:	e9 52 ff ff ff       	jmp    80105752 <trap+0x222>
...
8010581a:	c7 04 24 14 77 10 80 	movl   $0x80107714,(%esp)
80105821:	89 44 24 04          	mov    %eax,0x4(%esp)
80105825:	e8 26 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010582a:	c7 04 24 e9 76 10 80 	movl   $0x801076e9,(%esp)
80105831:	e8 2a ab ff ff       	call   80100360 <panic>
	  panic("you ran out of memory");	}
80105836:	c7 04 24 c1 76 10 80 	movl   $0x801076c1,(%esp)
8010583d:	e8 1e ab ff ff       	call   80100360 <panic>
80105842:	0f 20 d2             	mov    %cr2,%edx
	cprintf("rcr2 =  %d\nBottom: %d\n",rcr2(),KERNBASE - 4 - curproc->num_pgs*PGSIZE);
80105845:	89 44 24 08          	mov    %eax,0x8(%esp)
80105849:	89 54 24 04          	mov    %edx,0x4(%esp)
8010584d:	c7 04 24 86 76 10 80 	movl   $0x80107686,(%esp)
80105854:	e8 f7 ad ff ff       	call   80100650 <cprintf>
	panic("asdflajsd");
80105859:	c7 04 24 9d 76 10 80 	movl   $0x8010769d,(%esp)
80105860:	e8 fb aa ff ff       	call   80100360 <panic>
...
80105957:	00 
  for(p="xv6...\n"; *p; p++)
80105958:	bb 54 78 10 80       	mov    $0x80107854,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106482:	e8 09 de ff ff       	call   80104290 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010653a:	c3                   	ret    
        panic("kfree");
8010653b:	c7 04 24 42 71 10 80 	movl   $0x80107142,(%esp)
...
80106553:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106556:	e8 35 d1 ff ff       	call   80103690 <cpuid>
...
80106681:	c3                   	ret    
      panic("remap");
80106682:	c7 04 24 5c 78 10 80 	movl   $0x8010785c,(%esp)
...
801066d4:	0f 84 c3 00 00 00    	je     8010679d <switchuvm+0xed>
  pushcli();
801066da:	e8 31 da ff ff       	call   80104110 <pushcli>
...
8010678b:	5d                   	pop    %ebp
  popcli();
8010678c:	e9 3f da ff ff       	jmp    801041d0 <popcli>
    panic("switchuvm: no process");
80106791:	c7 04 24 62 78 10 80 	movl   $0x80107862,(%esp)
80106798:	e8 c3 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010679d:	c7 04 24 8d 78 10 80 	movl   $0x8010788d,(%esp)
801067a4:	e8 b7 9b ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801067a9:	c7 04 24 78 78 10 80 	movl   $0x80107878,(%esp)
...
801067f5:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801067f7:	e8 94 da ff ff       	call   80104290 <memset>
...
80106838:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106839:	e9 f2 da ff ff       	jmp    80104330 <memmove>
    panic("inituvm: more than a page");
8010683e:	c7 04 24 a1 78 10 80 	movl   $0x801078a1,(%esp)
...
801068f2:	c7 04 24 bb 78 10 80 	movl   $0x801078bb,(%esp)
801068f9:	e8 62 9a ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801068fe:	c7 04 24 78 79 10 80 	movl   $0x80107978,(%esp)
...
801069a2:	c7 04 24 d9 78 10 80 	movl   $0x801078d9,(%esp)
...
801069d0:	c7 04 24 f1 78 10 80 	movl   $0x801078f1,(%esp)
...
80106a93:	e9 68 b8 ff ff       	jmp    80102300 <kfree>
    panic("freevm: no pgdir");
80106a98:	c7 04 24 0d 79 10 80 	movl   $0x8010790d,(%esp)
...
80106adb:	e8 b0 d7 ff ff       	call   80104290 <memset>
...
80106b7b:	c3                   	ret    
    panic("clearpteu");
80106b7c:	c7 04 24 1e 79 10 80 	movl   $0x8010791e,(%esp)
...
80106b96:	83 ec 2c             	sub    $0x2c,%esp
  ...
  char *mem;
  struct proc* p = myproc();
80106b99:	e8 12 cb ff ff       	call   801036b0 <myproc>
...
80106bab:	0f 84 75 01 00 00    	je     80106d26 <copyuvm+0x196>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106bb1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106bb4:	85 c0                	test   %eax,%eax
80106bb6:	0f 84 ac 00 00 00    	je     80106c68 <copyuvm+0xd8>
...
80106bd5:	e8 56 d7 ff ff       	call   80104330 <memmove>
...
80106c1f:	0f 84 08 01 00 00    	je     80106d2d <copyuvm+0x19d>
    if(!(*pte & PTE_P))
80106c25:	8b 30                	mov    (%eax),%esi
80106c27:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c2d:	0f 84 06 01 00 00    	je     80106d39 <copyuvm+0x1a9>
    pa = PTE_ADDR(*pte);
...
80106c3e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c44:	e8 67 b8 ff ff       	call   801024b0 <kalloc>
...
80106c66:	5d                   	pop    %ebp
80106c67:	c3                   	ret    
  for(i = PGROUNDUP(KERNBASE - 4 - p->num_pgs*PGSIZE); i < KERNBASE - 4; i += PGSIZE){
80106c68:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106c6b:	8b 58 7c             	mov    0x7c(%eax),%ebx
80106c6e:	f7 db                	neg    %ebx
80106c70:	c1 e3 0c             	shl    $0xc,%ebx
80106c73:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106c79:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106c7f:	76 5b                	jbe    80106cdc <copyuvm+0x14c>
80106c81:	e9 95 00 00 00       	jmp    80106d1b <copyuvm+0x18b>
...
80106c9d:	e8 8e d6 ff ff       	call   80104330 <memmove>
	if(mappages(d, (void*)i, PGSIZE,V2P(mem), flags) < 0){
80106ca2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ca5:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106cab:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106caf:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106cb6:	00 
80106cb7:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106cbb:	89 44 24 10          	mov    %eax,0x10(%esp)
80106cbf:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106cc2:	89 04 24             	mov    %eax,(%esp)
80106cc5:	e8 46 f9 ff ff       	call   80106610 <mappages>
80106cca:	85 c0                	test   %eax,%eax
80106ccc:	78 85                	js     80106c53 <copyuvm+0xc3>
  for(i = PGROUNDUP(KERNBASE - 4 - p->num_pgs*PGSIZE); i < KERNBASE - 4; i += PGSIZE){
80106cce:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106cd4:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106cda:	77 3f                	ja     80106d1b <copyuvm+0x18b>
	if((pte = walkpgdir(pgdir, (void*)i,0)) == 0){
80106cdc:	8b 45 08             	mov    0x8(%ebp),%eax
80106cdf:	31 c9                	xor    %ecx,%ecx
80106ce1:	89 da                	mov    %ebx,%edx
80106ce3:	e8 38 f7 ff ff       	call   80106420 <walkpgdir>
80106ce8:	85 c0                	test   %eax,%eax
80106cea:	74 41                	je     80106d2d <copyuvm+0x19d>
	if(!(*pte & PTE_P)){
80106cec:	8b 30                	mov    (%eax),%esi
80106cee:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106cf4:	74 4f                	je     80106d45 <copyuvm+0x1b5>
	pa = PTE_ADDR(*pte);
80106cf6:	89 f7                	mov    %esi,%edi
	flags = PTE_FLAGS(*pte);
80106cf8:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106cfe:	89 75 e4             	mov    %esi,-0x1c(%ebp)
	pa = PTE_ADDR(*pte);
80106d01:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
	if((mem = kalloc()) == 0){
80106d07:	e8 a4 b7 ff ff       	call   801024b0 <kalloc>
80106d0c:	85 c0                	test   %eax,%eax
80106d0e:	89 c6                	mov    %eax,%esi
80106d10:	0f 85 72 ff ff ff    	jne    80106c88 <copyuvm+0xf8>
80106d16:	e9 38 ff ff ff       	jmp    80106c53 <copyuvm+0xc3>
80106d1b:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106d1e:	83 c4 2c             	add    $0x2c,%esp
80106d21:	5b                   	pop    %ebx
80106d22:	5e                   	pop    %esi
80106d23:	5f                   	pop    %edi
80106d24:	5d                   	pop    %ebp
...
80106d28:	e9 33 ff ff ff       	jmp    80106c60 <copyuvm+0xd0>
      panic("copyuvm: pte should exist");
80106d2d:	c7 04 24 28 79 10 80 	movl   $0x80107928,(%esp)
80106d34:	e8 27 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: page not present");
80106d39:	c7 04 24 42 79 10 80 	movl   $0x80107942,(%esp)
80106d40:	e8 1b 96 ff ff       	call   80100360 <panic>
		panic("copyuvm: page nkkot present");}
80106d45:	c7 04 24 5c 79 10 80 	movl   $0x8010795c,(%esp)
80106d4c:	e8 0f 96 ff ff       	call   80100360 <panic>
80106d51:	eb 0d                	jmp    80106d60 <uva2ka>
80106d53:	90                   	nop
80106d54:	90                   	nop
80106d55:	90                   	nop
80106d56:	90                   	nop
...
80106d6e:	e8 ad f6 ff ff       	call   80106420 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106ddc:	e8 4f d5 ff ff       	call   80104330 <memmove>
    len -= n;
    buf += n;
...
80106e36:	c7 44 24 04 9c 79 10 	movl   $0x8010799c,0x4(%esp)
80106e3d:	80 
80106e3e:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e45:	e8 16 d2 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106e4a:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106e51:	e8 fa d2 ff ff       	call   80104150 <acquire>
80106e56:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106e5b:	90                   	nop
